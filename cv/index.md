...
<div class="cv-top-bar">
  <p class="cv-contact-line">
    London, UK · <a href="mailto:helene.draux@gmail.com">helene.draux@gmail.com</a> · <a href="https://researchmusings.substack.com">researchmusings.substack.com</a>
  </p>
  <a class="cv-download" href="/cv/helene-draux-cv.pdf" download>Download PDF</a>
</div>
...
- Designed and built a hybrid AI classification pipeline (Python + SLMs + LLMs) to categorise research funder organisations across five analytical dimensions.
- Developed a governance framework for conversational analytics, formalising how semantic constraints, structured data context, and workflow enforcement can make LLM-mediated analysis more reliable, auditable, and commercially usable.
- Designed and prototyped an AI-assisted research-intelligence workflow translating natural-language analytical intent into structured analytical inputs over large-scale bibliometric data.
...
- Managed a portfolio of client projects involving requirements gathering, proposal writing, client discussions, analytical execution, and presentation of findings to technical and non-technical stakeholders.
- Built and maintained data models, classification systems, and analytical workflows over large-scale bibliometric datasets using Google BigQuery and related data infrastructure.
- Developed complex SQL pipelines on Google BigQuery, including multi-step classification workflows with statistical thresholds, normalisation, and multi-criteria labelling to surface emerging research trends across 22 fields.
...
- Managed client relationships from initial meeting through order fulfilment and internal liaison.
